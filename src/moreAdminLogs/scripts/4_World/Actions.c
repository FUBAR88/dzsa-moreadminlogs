...
modded class ActionBase
{
	...
	{
		if (h_madHelper) h_madHelper.LogAction(this, "", action_data);
...
modded class AnimatedActionBase
{
	...
	{
		if (h_madHelper) h_madHelper.LogAction(this, "ANIMATED_", action_data);
...
modded class ActionContinuousBase
{
	...
	{
		if (h_madHelper) h_madHelper.LogAction(this, "CONTINUOUS_SERVER_", action_data);
		super.OnFinishProgressServer(action_data);
	}
	
	override void OnFinishProgress( ActionData action_data )
	{
		if (h_madHelper) h_madHelper.LogAction(this, "CONTINUOUS_", action_data);
